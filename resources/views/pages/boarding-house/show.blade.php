    ...
    <div id="Content-Container"
        ...
        <div id="TopNavAbsolute" class="absolute top-[60px] flex items-center justify-between w-full px-5 z-10">
            <a href="{{ route('home') }}"
                ...
                <img src="{{ asset('assets/assets/images/icons/arrow-left-transparent.svg') }}" class="w-8 h-8"
                    alt="icon">
            </a>
            <p class="font-semibold text-white">Details</p>
            <button
                class="w-12 h-12 flex items-center justify-center shrink-0 rounded-full overflow-hidden bg-white/10 backdrop-blur-sm">
                <img src="{{ asset('assets/assets/images/icons/like.svg') }}" class="w-[26px] h-[26px]" alt="">
            </button>
        </div>
        ...
        <main id="Details" class="relative flex flex-col rounded-t-[40px] py-5 pb-[10px] gap-4 bg-white z-10">
            <div id="Title" class="flex items-center justify-between gap-2 px-5">
                ...
                <div
                    ...
                    <img src="{{ asset('assets/assets/images/icons/star.svg') }}" class="w-6 h-6" alt="icon">
            ...
            <div id="Features" class="grid grid-cols-2 gap-x-[10px] gap-y-4 px-5">
                <div class="flex items-center gap-[6px]">
                    <img src="{{ asset('assets/assets/images/icons/location.svg') }}"
                        class="w-[26px] h-[26px] flex shrink-0" alt="icon">
                    <p class="text-ngekos-grey">Kota {{ $boardingHouse->city->name }}</p>
                </div>
                <div class="flex items-center gap-[6px]">
                    <img src="{{ asset('assets/assets/images/icons/3dcube.svg') }}" class="w-[26px] h-[26px] flex shrink-0"
                        alt="icon">
                ...
                <div class="flex items-center gap-[6px]">
                    <img src="{{ asset('assets/assets/images/icons/shield-tick.svg') }}"
                        class="w-[26px] h-[26px] flex shrink-0" alt="icon">
                            ...
                            <div
                                ...
                                <div class="flex">
                                    @for ($i = 0; $i < $testimonial->rating; $i++)
                                        <img src="{{ asset('assets/assets/images/icons/Star 1.svg') }}"
