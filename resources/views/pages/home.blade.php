...
@section('content')
    ...
    <div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
        ...
        <a href="#"
            ...
            <img src="{{ asset('assets/assets/images/icons/notification.svg') }}" class="w-[28px] h-[28px]" alt="icon">
        </a>
    </div>
    ...
    <section id="Popular" class="flex flex-col gap-4">
        <div class="flex items-center justify-between px-5">
            ...
            <div class="flex items-center gap-2">
                <span>See all</span>
                <img src="{{ asset('assets/assets/images/icons/arrow-right.svg')}}" class="w-6 h-6 flex shrink-0" alt="icon">
            </div>
            </a>
        </div>
                        ...
                        <a href="details.html" class="card">
                            <div
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        <img src="{{ asset('assets/assets/images/icons/profile-2use') }}r.svg" class="w-5 h-5 flex shrink-0"
                                            alt="icon">
                                    ...
                                    <p class="font-semibold text-lg text-ngekos-orange">
                                        ...
                                        <span
                                            class="text-sm text-ngekos-grey font-normal">
                                            /bulan
                                        </span></p>
                                </div>
                            </div>
                ...
                <a href="details.html" class="card">
                    <div
                        ...
                        <div class="flex flex-col gap-3 w-full">
                            ...
                            <hr class="border-[#F1F2F6]">
                            <div class="flex items-center gap-[6px]">
                                <img src="{{ asset('assets/assets/images/icons/location.svg') }}" class="w-5 h-5 flex shrink-0" alt="icon">
                                <p class="text-sm text-ngekos-grey">{{ $boardingHouse->city->name }}</p>
                            </div>
                            <div class="flex items-center gap-[6px]">
