        ...
        <div class="flex items-center justify-between px-5">
            ...
            <a href="#">
                <div class="flex items-center gap-2">
                    <span>See all</span>
                    <img src="{{ asset('assets/assets/images/icons/arrow-right.svg') }}" class="w-6 h-6 flex shrink-0"
                        alt="icon">
                </div>
            </a>
        </div>
                        ...
                        <a href="details.html" class="card">
                            <div
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        <img src="{{ asset('assets/assets/images/icons/3dcube.svg') }}"
                                            class="w-5 h-5 flex shrink-0" alt="icon">
                                        <p class="text-sm text-ngekos-grey">{{ $boardingHouse->category->name }}</p>
                                    </div>
                                    <div class="flex items-center gap-[6px]">
                                        <img src="{{ asset('assets/assets/images/icons/profile-2use') }}r.svg"
                                            class="w-5 h-5 flex shrink-0" alt="icon">
