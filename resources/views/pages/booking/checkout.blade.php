...
@section('content')
        ...
        <div class="flex flex-col w-full rounded-[30px] border border-[#F1F2F6] p-4 gap-4 bg-white">
            <div class="flex gap-4">
                ...
                <div class="flex flex-col gap-3 w-full">
                    ...
                    <div class="flex items-center gap-[6px]">
                        <img src="{{ asset('assets/assets/images/icons/location.svg') }}" class="w-5 h-5 flex shrink-0"
                            alt="icon">
                        <p class="text-sm text-ngekos-grey">Kota {{ $boardingHouse->city->name }}</p>
                    </div>
                    <div class="flex items-center gap-[6px]">
                        <img src="{{ asset('assets/assets/images/icons/profile-2user.svg') }}" class="w-5 h-5 flex shrink-0"
                            alt="icon">
            ...
            <div class="flex gap-4">
                ...
                <div class="flex flex-col gap-3 w-full">
                    ...
                    <div class="flex items-center gap-[6px]">
                        <img src="{{ asset('assets/assets/images/icons/3dcube.svg') }}" class="w-5 h-5 flex shrink-0"
                            alt="icon">
    ...
    <div
        ...
        <label class="relative flex items-center justify-between">
            ...
            <img src="{{ asset('assets/assets/images/icons/arrow-up.svg') }}"
        ...
        <div class="flex flex-col gap-4 pt-[22px]">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('assets/assets/images/icons/profile-2user.svg') }}" class="w-6 h-6 flex shrink-0"
                        alt="icon">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('assets/assets/images/icons/sms.svg') }}" class="w-6 h-6 flex shrink-0"
                        alt="icon">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('assets/assets/images/icons/call.svg') }}" class="w-6 h-6 flex shrink-0"
                        alt="icon">
    ...
    <div
        ...
        <div class="flex flex-col gap-4 pt-[22px]">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('assets/assets/images/icons/clock.svg') }}" class="w-6 h-6 flex shrink-0"
                        alt="icon">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('assets/assets/images/icons/calendar.svg') }}" class="w-6 h-6 flex shrink-0"
                        alt="icon">
        ...
        <div id="PaymentOptions" class="flex flex-col rounded-[30px] border border-[#F1F2F6] p-5 gap-4 mx-5">
            <div id="TabButton-Container" class="flex items-center justify-between border-b border-[#F1F2F6] gap-[18px]">
                <label class="tab-link group relative flex flex-col justify-between gap-4"
                    ...
                    <div class="flex items-center gap-3 mx-auto">
                        <div class="relative w-6 h-6">
                            <img src="{{ asset('assets/assets/images/icons/status-orange.svg') }}"
                                class="absolute w-6 h-6 flex shrink-0 opacity-0 group-has-[:checked]:opacity-100 transition-all duration-300"
                                alt="icon">
                            <img src="{{ asset('assets/assets/images/icons/status.svg') }}"
                ...
                <label class="tab-link group relative flex flex-col justify-between gap-4"
                    ...
                    <div class="flex items-center gap-3 mx-auto">
                        <div class="relative w-6 h-6">
                            <img src="{{ asset('assets/assets/images/icons/diamonds-orange.svg') }}"
                                class="absolute w-6 h-6 flex shrink-0 opacity-0 group-has-[:checked]:opacity-100 transition-all duration-300"
                                alt="icon">
                            <img src="{{ asset('assets/assets/images/icons/diamonds.svg') }}"
            ...
            <div id="TabContent-Container">
                ...
                <div id="DownPayment-Tab" class="tab-content flex flex-col gap-4">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <img src="{{ asset('assets/assets/images/icons/card-tick.svg') }}"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <img src="{{ asset('assets/assets/images/icons/receipt-2.svg') }}"
                                class="w-6 h-6 flex shrink-0" alt="icon">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <img src="{{ asset('assets/assets/images/icons/receipt-disscount.svg') }}"
                                class="w-6 h-6 flex shrink-0" alt="icon">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <img src="{{ asset('assets/assets/images/icons/security-user.svg') }}"
                                class="w-6 h-6 flex shrink-0" alt="icon">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <img src="{{ asset('assets/assets/images/icons/receipt-text.svg') }}"
                                class="w-6 h-6 flex shrink-0" alt="icon">
