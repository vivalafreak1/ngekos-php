...
@section('content')
    ...
    <div
        ...
        <div class="flex flex-col gap-4 pt-[22px]">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('assets/assets/images/icons/card-tick.svg') }}" class="w-6 h-6 flex shrink-0"
                        alt="icon">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('assets/assets/images/icons/receipt-2.svg') }}" class="w-6 h-6 flex shrink-0"
                        alt="icon">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('assets/assets/images/icons/security-user.svg') }}" class="w-6 h-6 flex shrink-0"
                        alt="icon">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('assets/assets/images/icons/receipt-text.svg') }}" class="w-6 h-6 flex shrink-0"
                        alt="icon">
            ...
            @if ($transaction->payment_status === 'pending')
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <img src="{{ asset('assets/assets/images/icons/security-card.svg') }}"
                            class="w-6 h-6 flex shrink-0" alt="icon">
...
@section('scripts')
    <script src="{{ asset('assets/assets/js/accodion.js') }}"></script>
    <script>
        // Get all tab buttons
