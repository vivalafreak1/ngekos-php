        ...
        <div class="flex flex-col w-full rounded-[30px] border border-[#F1F2F6] p-4 gap-4 bg-white">
            ...
            <div class="flex gap-4">
                ...
                <div class="flex flex-col gap-3 w-full">
                    ...
                    <hr class="border-[#F1F2F6]">
                    <div class="flex items-center gap-[6px]">
                        <img src="{{ asset('assets/assets/images/icons/profile-2user.svg') }}"
        ...
        <div id="InputContainer" class="flex flex-col gap-[18px]">
            ...
            <div class="flex flex-col w-full gap-2 px-5">
                ...
                <label
                    ...
                    <img src="{{ asset('assets/assets/images/icons/sms.svg') }}" class="w-5 h-5 flex shrink-0"
                        alt="icon">
                    <input type="email" name="email" id=""
                        class="appearance-none outline-none w-full font-semibold placeholder:text-ngekos-grey placeholder:font-normal"
                        placeholder="Write your email" {{ old('email') }}>
                </label>
                @error('email')
                    <p class="text-red-500 text-sm">{{ $message }}</p>
                @enderror
            ...
            <div class="flex flex-col w-full gap-2 px-5">
                ...
                <label
                    ...
                    <img src="{{ asset('assets/assets/images/icons/call.svg') }}" class="w-5 h-5 flex shrink-0"
                        alt="icon">
                    <input type="tel" name="phone_number" id=""
                        class="appearance-none outline-none w-full font-semibold placeholder:text-ngekos-grey placeholder:font-normal"
                        placeholder="Write your phone" {{ old('phone') }}>
                </label>
                @error('phone')
                    <p class="text-red-500 text-sm">{{ $message }}</p>
                @enderror
            ...
            <div class="flex items-center justify-between px-5">
                ...
                <div class="relative flex items-center gap-[10px] w-fit">
                    <button type="button" id="Minus" class="w-12 h-12 flex-shrink-0">
                        <img src="{{ asset('assets/assets/images/icons/minus.svg') }}" alt="icon">
                    </button>
                    ...
                    <button type="button" id="Plus" class="w-12 h-12 flex-shrink-0">
                        <img src="{{ asset('assets/assets/images/icons/plus.svg') }}" alt="icon">
                    </button>
                </div>
            </div>
