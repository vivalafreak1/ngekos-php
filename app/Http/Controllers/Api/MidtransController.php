...
class MidtransController extends Controller
{
    ...
    public function callback(Request $request)
    {
        ...
        $sid    = config('midtrans.twilio.sid');
        $token  = config('midtrans.twilio.token');
        ...
        $message = 
            ...
            "Tanggal check-in: " . date('d-m-Y', strtotime($transaction->start_date)) . PHP_EOL . PHP_EOL .
            "Terima kasih atas kepercayaan Anda kepada kami." . PHP_EOL .
